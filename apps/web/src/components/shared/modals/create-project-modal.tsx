              ...
              >
                {templatesLoading ? (
                  ...
                  (() => {
                    ...
                    const templatesByProfession = templates.reduce(
                      (acc, template) => {
                    ...
                    const sortedProfessions = Object.keys(
                      templatesByProfession,
                    ).sort();
                    ...
                    const filteredTemplates = getSelectedTemplates().filter(
                      (template) =>
                        template.name
                          .toLowerCase()
                            ...
                            <div className="p-4 space-y-1">
                              ...
                              {sortedProfessions.map((profession) => {
                                const professionTemplates =
                                  templatesByProfession[profession];
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <Badge
                                      variant="secondary"
                                      className="text-xs flex-shrink-0 px-1.5 min-w-[24px] text-center"
                                    >
                                  ...
                                  >
                                    ...
                                    <div className="p-6 space-y-4">
                                      <p className="text-muted-foreground">
                                        Start with a blank canvas and build your
                                        project exactly how you want it. Perfect
                                        for unique requirements or when you
                                        prefer full control over your project
                                        structure.
                                      </p>
                                ...
                                >
                                  <div className="mb-6">
                                    <h3 className="text-lg font-semibold flex items-center">
                                      {React.createElement(
                                        getProfessionIcon(selectedCategory),
                                        {
                                          className:
                                  ...
                                  {filteredTemplates.length === 0 ? (
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                      {filteredTemplates.map((template) => {
                                        ...
                                        const IconComponent = getProfessionIcon(
                                          template.profession,
                                        );
                      ...
                      <div className="space-y-3">
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <Button
                              variant="outline"
                              className="w-full justify-start glass-card h-11"
                            >
