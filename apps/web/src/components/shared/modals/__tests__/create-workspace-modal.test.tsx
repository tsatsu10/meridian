...
describe("CreateWorkspaceModal", () => {
  ...
  describe("Rendering", () => {
    it("should render modal when open", () => {
      render(<CreateWorkspaceModal open={true} onClose={mockOnClose} />, {
        wrapper: TestWrapper,
      });
      ...
      expect(
        screen.getByText(/create a new workspace to organize your projects/i),
      ).toBeInTheDocument();
    });
  ...
  describe("Form Submission", () => {
    ...
    it("should reset form when modal closes", async () => {
      ...
      rerender(<CreateWorkspaceModal open={true} onClose={mockOnClose} />);
