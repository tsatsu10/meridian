...
function BoardFilters({ onFiltersChange }: BoardFiltersProps) {
  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      {/* 📱 MOBILE RESPONSIVE: Stack controls on mobile */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 w-full">
        ...
        <div className="bg-zinc-100 dark:bg-zinc-800 rounded-md p-0.5 flex items-center shrink-0 w-full sm:w-auto">
          <button
            type="button"
            onClick={() => setViewMode("board")}
            className={cn(
              "flex items-center justify-center gap-1 px-2 py-1.5 sm:py-1 rounded-md transition-colors flex-1 sm:flex-none",
              viewMode === "board"
          ...
          >
            ...
            <span className="text-xs sm:text-xs">List</span>
          </button>
        </div>
      </div>
