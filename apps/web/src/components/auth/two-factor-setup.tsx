  ...
  const handleVerify = async () => {
    ...
    try {
      const response: BackupCodesResponse =
        await apiClient.auth.twoFactor.verify({
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Two-factor authentication (2FA) enhances your account security by
              requiring a second form of verification in addition to your
              password.
            </p>
        ...
        <CardContent className="space-y-6">
          ...
          <Alert>
            <AlertDescription className="text-sm">
              <strong>Remember:</strong> Each backup code can only be used once.
