...
function TeamSettings({
  ...
  const canManageTeam = ["admin", "team-lead", "workspace-manager"].includes(
    currentUserRole,
  );
  const canDeleteTeam = ["admin", "workspace-manager"].includes(
    currentUserRole,
  );
  ...
  const handleDelete = async () => {
    if (!window.confirm("This action cannot be undone. Delete this team?"))
      return;
...
describe("TeamSettings", () => {
  ...
  it("should render team name and description", () => {
    render(<TeamSettings team={mockTeam} currentUserRole="member" />, {
      wrapper: TestWrapper,
    });

    expect(screen.getByText("Engineering Team")).toBeInTheDocument();
    expect(
      screen.getByText("Main engineering team for product development"),
    ).toBeInTheDocument();
  });
  ...
  it("should show edit button for team leads", () => {
    render(<TeamSettings team={mockTeam} currentUserRole="team-lead" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should show edit button for admins", () => {
    render(<TeamSettings team={mockTeam} currentUserRole="admin" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should show archive button for team leads", () => {
    ...
    expect(
      screen.getByRole("button", { name: /archive team/i }),
    ).toBeInTheDocument();
  });
