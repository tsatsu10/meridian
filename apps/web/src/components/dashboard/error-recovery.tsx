...
export function ErrorRecovery({
  ...
  const [retryHistory, setRetryHistory] = useState<
    Array<{ time: Date; success: boolean }>
  >([]);
  ...
  const errorMessages = {
    ...
    data: {
      title: "Data Error",
      description:
        "There was a problem processing the data. This is usually temporary.",
      icon: "📊",
    },
    unknown: {
  ...
  return (
    <div className="flex items-center justify-center min-h-[400px] p-6">
      <Card
        className={cn("w-full max-w-2xl", severityColors[errorInfo.severity])}
      >
        <CardHeader>
            ...
            <div className="flex items-center gap-3">
              <div className="flex-shrink-0">
                <AlertTriangle
                  className={cn(
                    "h-8 w-8",
                    severityTextColors[errorInfo.severity],
                  )}
                />
              </div>
              <div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-yellow-600 dark:text-yellow-300 mt-1">
                    Please check your permissions or contact your workspace
                    administrator.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-2 space-y-1 pl-4">
                {retryHistory.map((attempt) => (
                  ...
                  >
                    ...
                    <span className="text-muted-foreground">
                      {attempt.time.toLocaleTimeString()} -{" "}
