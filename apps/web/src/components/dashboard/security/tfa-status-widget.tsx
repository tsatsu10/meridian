        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span
              className={cn(
                "font-bold text-2xl",
                getAdoptionColor(adoptionPercentage),
              )}
            >
              {adoptionPercentage}%
            </span>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                toggleEnforcementMutation.mutate(checked)
              }
                      ...
                      >
                        ...
                        {!user.hasTwoFactor && (
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              sendReminderMutation.mutate(user.email)
                            }
        ...
        {adoptionPercentage < 75 && (
          <div className="flex items-start gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            ...
            <div className="text-xs text-blue-900 dark:text-blue-200">
              <strong>Recommendation:</strong> Enable 2FA enforcement to improve
              workspace security. Users will be prompted to set up 2FA on their
              next login.
            </div>
          </div>
        )}
