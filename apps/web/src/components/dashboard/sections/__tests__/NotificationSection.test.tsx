...
describe("NotificationSection", () => {
  ...
  it("shows correct icons for different notification types", () => {
    render(
      <NotificationSection allNotifications={mockNotifications.slice(0, 2)} />,
    );
  ...
  it("displays formatted dates correctly", () => {
    render(
      <NotificationSection allNotifications={mockNotifications.slice(0, 1)} />,
    );
  ...
  it("displays priority badges correctly", () => {
    render(
      <NotificationSection allNotifications={mockNotifications.slice(0, 3)} />,
    );
    ...
    const longMessageNotification = [
      {
        ...
        message:
          "This is a very long message that should be handled properly by the component without breaking the layout or causing any issues",
        priority: "medium",
        timestamp: "2025-01-15T10:00:00Z",
        isRead: false,
      },
