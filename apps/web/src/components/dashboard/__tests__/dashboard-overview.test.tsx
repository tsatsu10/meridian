...
describe("DashboardOverview", () => {
  ...
  it("should handle zero tasks gracefully", () => {
    ...
    render(<DashboardOverview stats={statsWithNoTasks} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should show empty activity state", () => {
    render(<DashboardOverview stats={mockStats} recentActivity={[]} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle refresh action", async () => {
    ...
    render(<DashboardOverview stats={mockStats} onRefresh={onRefresh} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should display loading state", () => {
    ...
    expect(
      screen.getByText(/loading/i, { selector: ".sr-only" }),
    ).toBeInTheDocument();
  });

  it("should display error state", () => {
    render(<DashboardOverview error="Failed to load dashboard data" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should allow retrying after error", async () => {
    ...
    render(<DashboardOverview error="Failed to load" onRefresh={onRefresh} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should render visible widgets", () => {
    render(<DashboardOverview stats={mockStats} widgets={mockWidgets} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should show no widgets message when all hidden", () => {
    ...
    render(<DashboardOverview stats={mockStats} widgets={hiddenWidgets} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should render different widget types", () => {
    ...
    render(<DashboardOverview stats={mockStats} widgets={visibleWidgets} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle partial stats data", () => {
    ...
    render(<DashboardOverview stats={partialStats} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should render without stats prop", () => {
    ...
    expect(screen.getByText("Dashboard")).toBeInTheDocument();
    expect(
      screen.queryByLabelText(/dashboard statistics/i),
  ...
  it("should show percentage with proper formatting", () => {
    ...
    render(<DashboardOverview stats={statsWithDecimals} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle 100% task completion", () => {
    ...
    render(<DashboardOverview stats={statsComplete} />, {
      wrapper: TestWrapper,
    });
