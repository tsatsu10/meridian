...
describe("InteractiveChart", () => {
  ...
  it("renders bar chart when chartType is bar", () => {
    render(
      <InteractiveChart title="Test Chart" data={mockData} chartType="bar" />,
    );
  ...
  it("renders area chart when chartType is area", () => {
    render(
      <InteractiveChart title="Test Chart" data={mockData} chartType="area" />,
    );
  ...
  it("renders pie chart when chartType is pie", () => {
    render(
      <InteractiveChart title="Test Chart" data={mockData} chartType="pie" />,
    );
  ...
  it("displays trend information when showTrend is true", () => {
    render(
      <InteractiveChart title="Test Chart" data={mockData} showTrend={true} />,
    );
  ...
  it("handles drill down functionality when enabled", () => {
    ...
    expect(
      screen.getByText("Click on data points to drill down for more details"),
    ).toBeInTheDocument();
  });

  it("applies custom color when provided", () => {
    render(
      <InteractiveChart title="Test Chart" data={mockData} color="#ff0000" />,
    );
  ...
  it("applies custom height when provided", () => {
    render(
      <InteractiveChart title="Test Chart" data={mockData} height={400} />,
    );
...
describe("TaskCompletionChart", () => {
  it("renders with correct props", () => {
    const onDrillDown = vi.fn();
    render(<TaskCompletionChart data={mockData} onDrillDown={onDrillDown} />);
