...
export function TeamMemberProfileModal({
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "goals" | "activity">(
    "overview",
  );
        ...
        <Dialog open={open} onOpenChange={onClose}>
          <DialogContent className="max-w-5xl max-h-[90vh] overflow-hidden border-none p-0 gap-0 bg-gradient-to-br from-background via-background to-primary/5">
            ...
            >
              ...
              <div
                className="absolute bottom-10 right-20 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse"
              ...
              {!isOwnProfile && profileCompleteness < 100 && (
                ...
                >
                  <Badge
                    variant="secondary"
                    className="backdrop-blur-md bg-background/90 border border-border/50 shadow-lg px-3 py-1.5"
                  >
            ...
            >
              ...
              >
                ...
                >
                  <MagicCard
                    className="p-6 text-center cursor-pointer transition-all duration-300 hover:shadow-2xl border-2 border-transparent hover:border-blue-500/30"
                  ...
                  >
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div className="text-4xl md:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400">
                        <NumberTicker
                          value={profile.goals?.stats?.active || 0}
                        />
                      </div>
                      <p className="text-xs md:text-sm text-muted-foreground font-bold uppercase tracking-wider">
                        Active Goals
                      </p>
                    </div>
                  </MagicCard>
              ...
              <Tabs
                value={activeTab}
                onValueChange={(value) =>
                  setActiveTab(value as "overview" | "goals" | "activity")
                }
                className="w-full"
              >
                <TabsList className="grid w-full grid-cols-3 bg-muted/50 p-1 h-12">
                  <TabsTrigger
                    value="overview"
                    className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-primary data-[state=active]:to-primary/80 data-[state=active]:text-primary-foreground data-[state=active]:shadow-md transition-all font-medium"
                  >
                    Overview
                  </TabsTrigger>
                  <TabsTrigger
                    value="goals"
                    className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-blue-600 data-[state=active]:to-blue-500 data-[state=active]:text-white data-[state=active]:shadow-md transition-all font-medium"
                  >
                    Goals
                  </TabsTrigger>
                  <TabsTrigger
                    value="activity"
                    className="data-[state=active]:bg-gradient-to-br data-[state=active]:from-green-600 data-[state=active]:to-green-500 data-[state=active]:text-white data-[state=active]:shadow-md transition-all font-medium"
                  >
                    Activity
                  </TabsTrigger>
                </TabsList>
