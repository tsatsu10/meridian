    ...
    <Card className={cn("", className)}>
      <CardHeader className="pb-3">
        <CardTitle className="text-lg flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className={cn("text-xs font-medium", health.color, health.bg)}
          >
            {health.label}
          </Badge>
        </CardTitle>
            ...
            <div className="flex items-center justify-between p-3 bg-orange-50 rounded-md">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-orange-900">
                  {stats.upcomingHighRisk} upcoming high-risk milestone
                  {stats.upcomingHighRisk !== 1 ? "s" : ""}
                </span>
              </div>
        ...
        <div className="pt-4 border-t space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-medium">
              {stats.onTrack} milestone{stats.onTrack !== 1 ? "s" : ""}
            </span>
          </div>
          {stats.missRate > 0 && (
            <div className="flex justify-between text-sm">
