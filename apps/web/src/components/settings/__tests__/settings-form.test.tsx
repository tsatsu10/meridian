...
describe("Settings Form Component", () => {
  ...
  it("should toggle email notifications", async () => {
    ...
    const emailNotifCheckbox = screen.getByRole("checkbox", {
  ...
  it("should toggle push notifications", async () => {
    ...
    const pushNotifCheckbox = screen.getByRole("checkbox", {
  ...
  it("should save settings successfully", async () => {
    ...
    render(<SettingsForm initialSettings={defaultSettings} onSave={onSave} />, {
      wrapper: TestWrapper,
    });
