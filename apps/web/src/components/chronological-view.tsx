      ...
      <div className="flex items-center justify-center h-96 bg-gray-50 rounded-lg border">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Add tasks and milestones with dates to see chronological view
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Sequential view of all tasks and milestones ordered by date
            </p>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-500">
                  {dayGroup.items.filter((item) => item.type === "task").length}{" "}
                  tasks,{" "}
                  {
                    dayGroup.items.filter((item) => item.type === "milestone")
                      .length
                  }{" "}
                  milestones
            ...
            <div className="text-2xl font-bold text-gray-900">
              {
                timelineItems.filter(
                  (item) =>
                    item.status === "done" || item.status === "achieved",
                ).length
              }
            </div>
