        ...
        <form onSubmit={handleSubmit}>
          <Tabs defaultValue="details" className="w-full">
            ...
            <TabsContent value="details" className="space-y-4 py-4">
              ...
              {!isEditing && (
                <div className="space-y-2">
                  <Label htmlFor="baseRole">
                    Start from Template (Optional)
                  </Label>
                  <Select
                    value={formData.baseRoleId}
                    onValueChange={(value) =>
                      setFormData((prev) => ({ ...prev, baseRoleId: value }))
                    }
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="template-viewer">
                        Viewer Template
                      </SelectItem>
                      <SelectItem value="template-contributor">
                        Contributor Template
                      </SelectItem>
                      <SelectItem value="template-manager">
                        Manager Template
                      </SelectItem>
                      <SelectItem value="template-administrator">
