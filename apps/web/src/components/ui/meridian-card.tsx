...
const meridianCardHeaderVariants = cva(
  ["flex flex-col space-y-1.5 pb-4", "border-b border-border/50"],
  {
    variants: {
      variant: {
        default: "",
...
const MeridianCardHeader = React.forwardRef<
  HTMLDivElement,
  MeridianCardHeaderProps
...
const MeridianCardFooter = React.forwardRef<
  HTMLDivElement,
  MeridianCardFooterProps
>(({ className, variant, ...props }, ref) => (
  <div
    ref={ref}
            ...
            {icon && (
              <div
                className={cn(
                  "p-2 rounded-lg",
                  colorScheme === "primary" &&
                    "bg-meridian-primary/10 text-meridian-primary",
                  colorScheme === "success" &&
                    "bg-meridian-success/10 text-meridian-success",
                  colorScheme === "warning" &&
                    "bg-meridian-warning/10 text-meridian-warning",
                  colorScheme === "error" &&
                    "bg-meridian-error/10 text-meridian-error",
                )}
              >
                {icon}
              </div>
