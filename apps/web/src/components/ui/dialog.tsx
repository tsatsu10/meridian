  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        // Use proper Radix aria attributes for accessibility
        aria-labelledby={!hasTitle ? fallbackTitleId : undefined}
        aria-describedby={!hasDescription ? fallbackDescriptionId : undefined}
        {...props}
      >
        {/* Hidden fallback title for accessibility when no DialogTitle is provided */}
        {!hasTitle && (
        ...
        {children}
        {/* Hidden fallback description for accessibility when no DialogDescription is provided */}
        {!hasDescription && (
