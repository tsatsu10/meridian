  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      ...
      badgeColor: {
        ...
        gray: "bg-secondary text-secondary-foreground dark:bg-secondary-hover dark:text-secondary-foreground border-border",
        "dark-gray":
          "bg-muted text-muted-foreground dark:bg-muted-hover dark:text-muted-foreground border-border",
