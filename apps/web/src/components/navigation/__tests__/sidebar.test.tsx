...
describe("Sidebar", () => {
  ...
  it("should display all navigation items", () => {
    render(<Sidebar navItems={mockNavItems} userRole="admin" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should highlight active route", () => {
    render(<Sidebar navItems={mockNavItems} currentPath="/dashboard" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle navigation clicks", async () => {
    ...
    render(<Sidebar navItems={mockNavItems} onNavigate={onNavigate} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should render collapsed state correctly", () => {
    render(<Sidebar navItems={mockNavItems} isCollapsed={true} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should filter items based on user role", () => {
    render(<Sidebar navItems={mockNavItems} userRole="member" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should show admin items for workspace-manager role", () => {
    render(<Sidebar navItems={mockNavItems} userRole="workspace-manager" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should display workspace name", () => {
    render(<Sidebar navItems={mockNavItems} workspaceName="My Workspace" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should display project name", () => {
    render(<Sidebar navItems={mockNavItems} projectName="Project Alpha" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should display user role badge", () => {
    render(<Sidebar navItems={mockNavItems} userRole="team-lead" />, {
      wrapper: TestWrapper,
    });

    expect(
      screen.getByLabelText(/current role: team-lead/i),
    ).toBeInTheDocument();
  });
  ...
  it("should handle items without children", async () => {
    ...
    expect(onNavigate).toHaveBeenCalledWith("/dashboard");
    expect(
      screen.queryByRole("list", { name: /children/i }),
        ...
        children: [
          {
            ...
            label: "Level 2",
            path: "/level2",
            children: [{ id: "level3", label: "Level 3", path: "/level3" }],
          },
        ],
      },
    ];

    const { container } = render(<Sidebar navItems={deepNavItems} />, {
      wrapper: TestWrapper,
    });
