...
describe("FormWithValidation", () => {
  ...
  it("should render form with all fields", () => {
    render(<FormWithValidation fields={basicFields} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should prevent submission with validation errors", async () => {
    ...
    render(<FormWithValidation fields={basicFields} onSubmit={onSubmit} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle async validation", async () => {
    ...
    render(<FormWithValidation fields={fieldsWithAsync} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle select fields", async () => {
    ...
    render(<FormWithValidation fields={selectFields} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should validate max length", async () => {
        ...
        validationRules: [
          {
            type: "maxLength",
            value: 10,
            message: "Bio must be at most 10 characters",
          },
        ],
      },
    ];

    render(<FormWithValidation fields={maxLengthFields} />, {
      wrapper: TestWrapper,
    });
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Bio must be at most 10 characters"),
      ).toBeInTheDocument();
    });
  });
  ...
  it("should validate pattern", async () => {
    ...
    render(<FormWithValidation fields={patternFields} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle default values", () => {
    ...
    render(<FormWithValidation fields={fieldsWithDefaults} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should validate multiple rules in order", async () => {
    ...
    render(<FormWithValidation fields={multiRuleFields} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle number input type", async () => {
    ...
    render(<FormWithValidation fields={numberFields} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should validate all fields on submit", async () => {
    ...
    render(<FormWithValidation fields={multipleFields} onSubmit={onSubmit} />, {
      wrapper: TestWrapper,
    });
  ...
  it("should handle password input type", async () => {
    ...
    render(<FormWithValidation fields={passwordFields} />, {
      wrapper: TestWrapper,
    });
