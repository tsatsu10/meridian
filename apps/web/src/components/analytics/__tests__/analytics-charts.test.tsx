...
function AnalyticsCharts({
  ...
  const [hoveredDataPoint, setHoveredDataPoint] = React.useState<number | null>(
    null,
  );
...
describe("AnalyticsCharts", () => {
  ...
  it("should hide legend when showLegend is false", () => {
    ...
    expect(
      screen.queryByRole("list", { name: /chart legend/i }),
  ...
  it("should show retry button on error", () => {
    render(<AnalyticsCharts data={mockChartData} error="Network error" />, {
      wrapper: TestWrapper,
    });
  ...
  it("should be accessible", () => {
    ...
    expect(
      screen.getByRole("tablist", { name: /chart type/i }),
    ).toBeInTheDocument();
    expect(screen.getByRole("img")).toHaveAccessibleName();
    expect(
      screen.getByRole("list", { name: /chart legend/i }),
    ).toBeInTheDocument();
  });
