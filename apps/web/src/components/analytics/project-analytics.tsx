  ...
  const {
    ...
    queryFn: async () => {
      const response = await fetch(
        `${API_BASE_URL}/projects/${projectId}/analytics?timeRange=${timeRange}`,
        {
          credentials: "include",
        },
      );
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {data?.lastUpdated && (
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span>
                Updated {formatDistanceToNow(new Date(data.lastUpdated))} ago
              </span>
              <TooltipProvider>
                <Tooltip>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {Math.round(data.timeMetrics.totalHours)}
                </p>
                <p className="text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          className={cn("border-2", getHealthColor(data.projectHealth.score))}
        >
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge
                variant="outline"
                className={getHealthColor(data.projectHealth.score)}
              >
          ...
          <CardContent>
            ...
            {data.projectHealth.riskFactors &&
              data.projectHealth.riskFactors.length > 0 && (
                <div>
      ...
      {data?.teamMetrics?.memberPerformance &&
        data.teamMetrics.memberPerformance.length > 0 && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {data?.velocityMetrics && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                <span>
                  Current: {data.velocityMetrics.current.toFixed(1)} tasks/week
                </span>
              </CardDescription>
              <div className="flex items-center gap-2 mt-1">
                {data.velocityMetrics.trend === "increasing" && (
                  <Badge variant="default">
                    ...
                    {Math.abs(data.velocityMetrics.changePercentage).toFixed(1)}
                    % up
                  </Badge>
                )}
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {data.velocityMetrics.current.toFixed(1)}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      tasks per week
                    </p>
                  ...
                  >
                    ...
                    {data.velocityMetrics.trend === "stable" && (
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <p className="text-xl font-bold">
                      {data.velocityMetrics.historical.toFixed(1)}
                    </p>
                    <p className="text-xs text-muted-foreground">
                      tasks per week
                    </p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Visualize task completion over time</CardDescription>
        </CardHeader>
        <CardContent>
          <InteractiveChart
        ...
        <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950/20">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <div className="flex items-center gap-3">
                <kbd className="px-2 py-1 bg-white dark:bg-gray-900 rounded border">
                  Cmd/Ctrl + R
                </kbd>
