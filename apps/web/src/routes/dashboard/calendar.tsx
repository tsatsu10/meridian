...
function GlobalCalendar() {
  ...
  const globalEvents: GlobalCalendarEvent[] = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        title: "Team Standup",
        start: new Date(
          addDays(today, 1).getFullYear(),
          addDays(today, 1).getMonth(),
      ...
      },
      {
        ...
        start: new Date(
          addDays(today, 30).getFullYear(),
          addDays(today, 30).getMonth(),
          addDays(today, 30).getDate(),
          10,
          0,
        ),
        end: new Date(
  ...
  const navigateWeek = (direction: "prev" | "next") => {
    setCurrentDate(
      direction === "next" ? addDays(currentDate, 7) : subDays(currentDate, 7),
    );
  };
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-500">
                {
                  teamAvailability.filter((m) => m.status === "available")
                    .length
                }
              </div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold">
                {Math.round(
                  teamAvailability.reduce((avg, m) => avg + m.workload, 0) /
          ...
          {timelineEvents.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">
                Events will appear here as they're created.
              </p>
            </div>
          )}
        </div>
