...
function AuditLogsSettings() {
  ...
  const { data: settings, isLoading: settingsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `${API_BASE_URL}/settings/audit/${currentWorkspace.id}/settings`,
        {
          credentials: "include",
        },
      );
  ...
  const { data: logsData, isLoading: logsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (selectedUser && selectedUser !== "all")
        params.append("userEmail", selectedUser);
      ...
      const response = await fetch(
        `${API_BASE_URL}/settings/audit/${currentWorkspace.id}/logs?${params}`,
        {
          credentials: "include",
        },
      );
  ...
  const { data: filterOptions } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `${API_BASE_URL}/settings/audit/${currentWorkspace.id}/filters`,
        {
          credentials: "include",
        },
      );
  ...
  const { data: stats } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `${API_BASE_URL}/settings/audit/${currentWorkspace.id}/stats?${params}`,
        {
          credentials: "include",
        },
      );
  ...
  const handleExport = async (format: "json" | "csv") => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/settings/audit/${currentWorkspace.id}/export`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          credentials: "include",
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">
                View workspace activity and configure audit logging
              </p>
            </div>
          </div>
          {hasChanges && (
          ...
          <TabsContent value="logs" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Showing {logsData?.logs.length || 0} of {logsData?.total || 0}{" "}
                  activities
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="settings" className="space-y-6">
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleChange("logUserActions", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleChange("logSystemActions", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleChange("logAPIRequests", checked)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          handleChange("logSecurityEvents", checked)
                        }
                      />
                    </div>
                  </>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleChange("autoArchiveEnabled", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleChange("autoDeleteEnabled", checked)
                    }
                  />
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure compliance and security options
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleChange("immutableLogs", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Admin approval required to delete logs
                    </p>
                  </div>
                  <Switch
                    checked={formData.requireApprovalForDeletion ?? true}
                    onCheckedChange={(checked) =>
                      handleChange("requireApprovalForDeletion", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleChange("notifyOnCriticalActions", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleChange("allowLogExport", checked)
                    }
                  />
                </div>
              </CardContent>
