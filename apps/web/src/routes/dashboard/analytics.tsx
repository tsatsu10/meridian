...
const EnhancedMetricCard = ({
  ...
  const hasComparison =
    comparativeData.comparison !== undefined &&
    comparativeData.comparison !== null;
        ...
        {hasChange && (
          <div
            className={cn(
              ...
              comparativeData.change.trend === "up"
                ? "bg-green-500"
                : comparativeData.change.trend === "down"
                  ? "bg-red-500"
                  : "bg-gray-500",
            )}
          />
                ...
                {hasChange && (
                  ...
                  >
                    ...
                    <span className="tabular-nums">
                      {Math.abs(comparativeData.change.percentage)}%
                    </span>
                  </div>
                )}
              </div>
                ...
                <div className="mt-2 flex items-center gap-2 text-xs">
                  ...
                  {hasChange && (
                    <>
                      ...
                      >
                        {comparativeData.change.absolute > 0 ? "+" : ""}
                        {comparativeData.change.absolute}
                      </span>
                    </>
                  )}
                </div>
      ...
      <Card className="glass-card border-border/50 hover:border-primary/40 hover:shadow-lg transition-all duration-200">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div
              className={cn("p-1 rounded-full", getHealthColor(project.health))}
            >
...
const analyticsReducer = (
  ...
  switch (action.type) {
    ...
    case "TOGGLE_EXPORT_DIALOG":
      return {
        ...state,
        showExportDialog: action.payload ?? !state.showExportDialog,
      };
    case "TOGGLE_FILTER_PANEL":
      return {
        ...state,
        showFilterPanel: action.payload ?? !state.showFilterPanel,
      };
    case "TOGGLE_SETTINGS_DIALOG":
      return {
        ...state,
        showSettingsDialog: action.payload ?? !state.showSettingsDialog,
      };
    case "TOGGLE_COMPARISON_DIALOG":
      return {
        ...state,
        showComparisonDialog: action.payload ?? !state.showComparisonDialog,
      };
    case "TOGGLE_KEYBOARD_SHORTCUTS":
      return {
        ...state,
        showKeyboardShortcuts: action.payload ?? !state.showKeyboardShortcuts,
      };
    case "TOGGLE_ONBOARDING_TOUR":
      return {
        ...state,
        showOnboardingTour: action.payload ?? !state.showOnboardingTour,
      };
    case "TOGGLE_SCHEDULED_REPORTS":
      return {
        ...state,
        showScheduledReports: action.payload ?? !state.showScheduledReports,
      };
    case "TOGGLE_CUSTOM_WIDGETS":
      return {
        ...state,
        showCustomWidgets: action.payload ?? !state.showCustomWidgets,
      };
    ...
    case "TOGGLE_COMPARISON_MODE":
      return {
        ...state,
        comparisonMode: action.payload ?? !state.comparisonMode,
      };
      ...
      <div className="space-y-6 md:space-y-8 p-4 md:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
            ...
            <Button
              onClick={() =>
                dispatch({ type: "TOGGLE_SCHEDULED_REPORTS", payload: true })
              }
              variant="ghost"
              size="sm"
              className="h-9 gap-2"
            ...
            <Button
              onClick={() =>
                dispatch({ type: "TOGGLE_CUSTOM_WIDGETS", payload: true })
              }
              variant="ghost"
              size="sm"
              className="h-9 gap-2"
            ...
            >
              <RefreshCw
                className={cn("h-4 w-4", state.isRefreshing && "animate-spin")}
              />
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                >
                  <kbd className="text-xs mr-2 px-1.5 py-0.5 rounded bg-muted">
                    ?
                  </kbd>
                  Keyboard Shortcuts
                </DropdownMenuItem>
                  ...
                  <div className="flex items-center gap-1">
                    <div className="w-20 h-2 bg-muted rounded-full">
                      <div
                        ...
                        style={{
                          width: `${enhancedAnalytics?.summary?.dataQuality || 0}%`,
                        }}
                      />
                    </div>
                    <span className="text-sm font-medium">
                      {enhancedAnalytics?.summary?.dataQuality || 0}/100
                    </span>
                  </div>
                  <Badge
                    variant={
                      (enhancedAnalytics?.summary?.dataQuality || 0) >= 80
                        ? "default"
                        : "secondary"
                    }
                  >
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <EnhancedMetricCard
                    ...
                    comparativeData={
                      enhancedAnalytics.timeMetrics.timeUtilization
                    }
                    icon={Activity}
                    color="bg-pink-500"
                  ...
                  <EnhancedMetricCard
                    ...
                    comparativeData={
                      enhancedAnalytics.projectMetrics.projectsAtRisk
                    }
                    icon={AlertTriangle}
                    color="bg-red-500"
                      ...
                      {enhancedAnalytics.timeSeriesData?.length > 0 ? (
                        ...
                        >
                          <InteractiveChart
                            ...
                            data={enhancedAnalytics.timeSeriesData.map(
                              (point) => ({
                                label: new Date(
                                  point.date,
                                ).toLocaleDateString(),
                        ...
                        <div className="h-64 flex items-center justify-center">
                          <div className="text-center space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground/75">
                              Complete tasks over the next few days to see
                              trends
                            </p>
                          </div>
                        </div>
                      ...
                      {enhancedAnalytics.resourceUtilization?.length > 0 ? (
                        ...
                        >
                          <InteractiveChart
                            ...
                            data={enhancedAnalytics.resourceUtilization
                              .slice(0, 5)
                              .map((resource) => ({
                        ...
                        <div className="h-64 flex items-center justify-center">
                          <div className="text-center space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground/75">
                              Assign team members to tasks to see resource
                              distribution
                            </p>
                          </div>
                        </div>
        ...
        <Dialog
          ...
          onOpenChange={(open) =>
            dispatch({ type: "TOGGLE_EXPORT_DIALOG", payload: open })
          }
        >
          <DialogContent className="sm:max-w-md">
                ...
                <p className="text-sm flex items-start gap-2">
                  ...
                  <span>
                    {state.exportFormat === "csv" &&
                      "CSV format is ideal for data analysis in spreadsheet applications."}
                    {state.exportFormat === "pdf" &&
                      "PDF format creates a printable report with visualizations."}
                    {state.exportFormat === "excel" &&
                      "Excel format includes multiple sheets with formatted tables for comprehensive analysis."}
                  </span>
                </p>
              </div>
            </div>
            ...
            <DialogFooter className="gap-2">
              ...
              <Button
                onClick={() => handleExport(state.exportFormat)}
                className="gap-2"
              >
                <Download className="h-4 w-4" />
        ...
        >
          <SheetContent className="w-full sm:max-w-md overflow-y-auto">
            <SheetHeader>
              ...
              <SheetDescription>
                Customize your analytics view with filters and comparison
                options
              </SheetDescription>
            </SheetHeader>
            ...
            <div className="space-y-6 py-6">
              ...
              <div className="space-y-3">
                ...
                {userOptions.length === 0 && (
                  <p className="text-xs text-muted-foreground mt-1">
                    No team members active. Invite team members to start
                    filtering.
                  </p>
                )}
              </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {state.selectedProjects.length > 0 && (
                        <Badge variant="secondary">
                          {state.selectedProjects.length} Projects
                        </Badge>
                      )}
                      {state.selectedUsers.length > 0 && (
                        <Badge variant="secondary">
                          {state.selectedUsers.length} Users
                        </Badge>
                      )}
                      {state.customDateRange.start && (
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 border-t bg-background">
              <div className="flex gap-2">
                ...
                <Button
                  onClick={() =>
                    dispatch({ type: "TOGGLE_FILTER_PANEL", payload: false })
                  }
        ...
        <Dialog
          open={state.showComparisonDialog}
          onOpenChange={(open) =>
            dispatch({ type: "TOGGLE_COMPARISON_DIALOG", payload: open })
          }
        >
          <DialogContent className="sm:max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>
                Compare analytics across different time periods to identify
                trends and patterns
              </DialogDescription>
            </DialogHeader>
                ...
                <>
                  ...
                  <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                    <p className="text-sm flex items-start gap-2">
                      <Info className="h-4 w-4 mt-0.5 flex-shrink-0 text-blue-600" />
                      <span>
                        Comparison mode will display metrics side-by-side with
        ...
        <Dialog
          ...
          onOpenChange={(open) =>
            dispatch({ type: "TOGGLE_SETTINGS_DIALOG", payload: open })
          }
        >
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
        ...
        <KeyboardShortcutsModal
          ...
          onOpenChange={(open) =>
            dispatch({ type: "TOGGLE_KEYBOARD_SHORTCUTS", payload: open })
          }
        />
        ...
        <ScheduledReports
          ...
          onClose={() =>
            dispatch({ type: "TOGGLE_SCHEDULED_REPORTS", payload: false })
          }
        />
        ...
        <CustomWidgetsManager
          ...
          onClose={() =>
            dispatch({ type: "TOGGLE_CUSTOM_WIDGETS", payload: false })
          }
