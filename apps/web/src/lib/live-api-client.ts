...
export const liveApi = {
  ...
  analytics: {
    ...
    project: (projectId: string) =>
      liveApiClient.get(`/api/analytics/project/${projectId}`),
    notifications: (
      ...
      return liveApiClient.get(
        `/api/analytics/notifications?${query.toString()}`,
      );
    },
  },
  ...
  calendar: {
    ...
    availability: {
      list: (params: { workspaceId?: string; date?: string } = {}) => {
        ...
        return liveApiClient.get(
          `/api/calendar/availability?${query.toString()}`,
        );
      },
    },
  },
  ...
  apiKeys: {
    ...
    regenerate: (id: string) =>
      liveApiClient.post(`/api/api-keys/${id}/regenerate`),
