...
export const TaskStatusSchema = z
  .enum(["pending", "in-progress", "review", "done", "blocked", "cancelled"])
  .default("pending");
 ...
 */
export function validatePartialDashboardData(
  data: unknown,
 ...
 */
export function validateDashboardDataWithMetadata(
  data: unknown,
): ValidatedDashboardData {
