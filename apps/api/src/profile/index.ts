...
profile
  ...
  .get("/experience", async (c) => {
    try {
      ...
      logger.debug("✅ Experience retrieved successfully", {
  ...
  .get("/education", async (c) => {
    try {
      ...
      logger.debug("✅ Education retrieved successfully", {
  ...
  .get("/skills", async (c) => {
    try {
      ...
      logger.debug("✅ Skills retrieved successfully", {
        items: skills.length,
      });
  ...
  .get("/connections", async (c) => {
    try {
      ...
      logger.debug("✅ Connections retrieved successfully", {
