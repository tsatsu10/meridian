...
class FileStorageService {
  ...
  constructor(config?: Partial<StorageConfig>) {
    ...
    this.uploadDir =
      this.config.localPath || path.join(process.cwd(), "uploads");
  ...
  private async uploadToS3(
    ...
    throw new Error(
      "S3 upload not implemented yet. Install @aws-sdk/client-s3 first.",
    );
  }
  ...
  private async uploadToR2(
    ...
    throw new Error(
      "R2 upload not implemented yet. Install @aws-sdk/client-s3 first.",
    );
  }
