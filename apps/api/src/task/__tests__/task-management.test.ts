...
describe.skipIf(!dbAvailable)("Task Management", () => {
  ...
  describe("Task Deletion", () => {
    ...
    it("should delete task", async () => {
      await db.delete(taskTable).where(eq(taskTable.id, testTask.id));
    ...
    it("should cascade delete when project is deleted", async () => {
      await db.delete(projectTable).where(eq(projectTable.id, testProject.id));
