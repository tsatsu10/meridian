...
describe.skipIf(!dbAvailable)("Calendar Events", () => {
  ...
  describe("Conflict Detection", () => {
    ...
    it("should detect overlapping events", () => {
      ...
      expect(
        checkConflict(event1Start, event1End, event2Start, event2End),
      ).toBe(true);
    });
