...
import {
  requireThemeProjectPermission,
  requireThemePermission,
} from "./middleware";
...
theme.get(
  "/:projectId",
  requireThemeProjectPermission("canViewWorkspace"),
  async (c) => {
    try {
...
theme.post(
  "/:projectId",
  requireThemeProjectPermission("canManageProjectSettings"),
...
theme.put(
  "/:themeId",
  requireThemePermission("canManageProjectSettings"),
