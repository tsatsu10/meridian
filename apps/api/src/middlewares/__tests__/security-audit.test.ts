...
describe("Security Audit Middleware", () => {
  ...
  describe("Failed authentication tracking", () => {
    ...
    it("should track attempts by user", () => {
      ...
      failedAttemptsByUser.set(
        userId,
        (failedAttemptsByUser.get(userId) || 0) + 1,
      );
  ...
  describe("Suspicious activity detection", () => {
    ...
    it("should detect unusual access patterns", () => {
      ...
      const isUnusual = !accessPattern.normalHours.includes(
        accessPattern.currentHour,
      );
  ...
  describe("IP address tracking", () => {
    it("should extract IP from request", () => {
      ...
      const ip =
        mockContext.req.header("x-forwarded-for") ||
  ...
  describe("Anomaly detection", () => {
    it("should detect unusual request patterns", () => {
      ...
      const isAnomaly =
        current.requestsThisHour > baseline.avgRequestsPerHour * 5;
    ...
    it("should detect unusual data modifications", () => {
      ...
      const isUnusual =
        modifications.tasksDeleted > modifications.normalDeleteRate * 10;
      expect(isUnusual).toBe(true);
    });
  });
  ...
  describe("Log retention", () => {
    it("should archive old logs", () => {
      ...
      const ageInDays =
        (now.getTime() - logAge.getTime()) / (1000 * 60 * 60 * 24);
