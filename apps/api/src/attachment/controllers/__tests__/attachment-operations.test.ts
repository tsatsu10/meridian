...
describe("Attachment Operations", () => {
  ...
  describe("Storage quota", () => {
    it("should calculate user storage usage", async () => {
      ...
      const totalUsage = userAttachments.reduce(
    ...
    it("should calculate workspace storage usage", () => {
      ...
      const totalWorkspaceStorage = projectUsage.reduce(
        (sum, p) => sum + p.storage,
        0,
      );
  ...
  describe("Attachment search", () => {
    ...
    it("should filter by date range", () => {
      ...
      const filtered = attachments.filter(
        (a) => a.uploadedAt >= startDate && a.uploadedAt <= endDate,
      );
  ...
  describe("Attachment statistics", () => {
    ...
    it("should identify most common file types", () => {
      ...
      const typeCounts = attachments.reduce(
        (acc, a) => {
