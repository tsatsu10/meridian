...
describe("Time Tracking", () => {
  ...
  describe("Time calculations", () => {
    it("should calculate total time for task", () => {
      const entries = [{ duration: 60 }, { duration: 90 }, { duration: 45 }];
  ...
  describe("Time reports", () => {
    ...
    it("should generate weekly report", () => {
      ...
      const totalHours =
        weeklyEntries.reduce((sum, e) => sum + e.duration, 0) / 60;
    ...
    it("should generate project time report", () => {
      ...
      const totalProjectHours = projectEntries.reduce(
        (sum, e) => sum + e.hours,
        0,
      );
  ...
  describe("Time analytics", () => {
    it("should calculate average time per task type", () => {
      ...
      const avgBugTime =
        bugTasks.reduce((sum, t) => sum + t.hours, 0) / bugTasks.length;
