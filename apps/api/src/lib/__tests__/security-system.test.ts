...
describe.skip("Security System", () => {
  ...
  describe("Security Service", () => {
    ...
    it("filters events by level", () => {
      ...
      const errorEvents = securityService.getEvents(
        undefined,
        SecurityLevel.ERROR,
      );
    ...
    it("filters events by context", () => {
      ...
      const userEvents = securityService.getEvents(undefined, undefined, {
        userId: "123",
      });
  ...
  describe("Security Error Handling", () => {
    ...
    it("handles event retrieval errors", () => {
      ...
      expect(() => {
        securityService.getEvents("", "invalid" as SecurityLevel, {
          invalid: "filter",
        });
      }).not.toThrow();
    });
