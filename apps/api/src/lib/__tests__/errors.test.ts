...
describe("Error Handling", () => {
  ...
  describe("Error Factory Functions", () => {
    ...
    it("creates validation error", () => {
      const error = createError.validationError("Validation failed", {
        errors: [],
      });
    ...
    it("creates server error", () => {
      const error = createError.serverError("Internal server error", {
        component: "database",
      });
    ...
    it("creates rate limited error", () => {
      const error = createError.rateLimited("Too many requests", {
        limit: 100,
      });
