...
describe.skip("Performance Monitoring System", () => {
  ...
  describe("Performance Service", () => {
    ...
    it("filters metrics by level", () => {
      ...
      const errorMetrics = performanceService.getMetrics(
        undefined,
    ...
    it("filters metrics by tags", () => {
      ...
      const apiMetrics = performanceService.getMetrics(undefined, undefined, {
        service: "api",
      });
  ...
  describe("Performance Error Handling", () => {
    ...
    it("handles metric retrieval errors", () => {
      ...
      expect(() => {
        performanceService.getMetrics("", "invalid" as PerformanceLevel, {
          invalid: "filter",
        });
      }).not.toThrow();
    });
