...
describe("Validator", () => {
  ...
  describe("validatePartial", () => {
    ...
    it("should throw ValidationError for invalid partial data", () => {
      ...
      expect(() => Validator.validatePartial(schema, data)).toThrow(
        ValidationError,
      );
    });
  });
  ...
  describe("validateQuery", () => {
    ...
    it("should throw ValidationError for invalid query parameters", () => {
      ...
      expect(() => Validator.validateQuery(schema, query)).toThrow(
        ValidationError,
      );
    });
  });
  ...
  describe("validateEnum", () => {
    ...
    it("should throw ValidationError for invalid enum value", () => {
      ...
      expect(() => Validator.validateEnum(value, enumValues)).toThrow(
        ValidationError,
      );
    });
  });
  ...
  describe("validateArray", () => {
    ...
    it("should throw ValidationError for invalid array item", () => {
      ...
      expect(() => Validator.validateArray(array, itemSchema)).toThrow(
        ValidationError,
      );
    });
  ...
  describe("validateObject", () => {
    ...
    it("should throw ValidationError for invalid object value", () => {
      ...
      expect(() => Validator.validateObject(obj, schema)).toThrow(
        ValidationError,
      );
    });
