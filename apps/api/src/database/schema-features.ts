...
export const workspaceSettings = pgTable(
  "workspace_settings",
  {
    ...
    requireApprovalForNewMembers: boolean("require_approval_for_new_members")
      .notNull()
      .default(false),
    ...
    enableProjectTemplates: boolean("enable_project_templates")
      .notNull()
      .default(true),
    enableAdvancedAnalytics: boolean("enable_advanced_analytics")
      .notNull()
      .default(false),
...
export const twoFactorStatus = pgTable(
  "two_factor_status",
  {
    id: serial("id").primaryKey(),
...
// GDPR Compliance
export const gdprDataRetentionPolicies = pgTable(
  "gdpr_data_retention_policies",
  {
    id: serial("id").primaryKey(),
...
export const gdprUserConsent = pgTable(
  "gdpr_user_consent",
  {
    id: serial("id").primaryKey(),
    userId: integer("user_id").notNull(),
...
export const revenueMetrics = pgTable(
  "revenue_metrics",
  {
    ...
    newRevenue: decimal("new_revenue", { precision: 12, scale: 2 })
      .notNull()
      .default("0"),
    churnRevenue: decimal("churn_revenue", { precision: 12, scale: 2 })
      .notNull()
      .default("0"),
...
export const projectRevenue = pgTable(
  "project_revenue",
  {
    id: serial("id").primaryKey(),
...
export const customerHealth = pgTable(
  "customer_health",
  {
    id: serial("id").primaryKey(),
  ...
  (table) => ({
    customerIdIdx: index("customer_health_customer_id_idx").on(
      table.customerId,
    ),
  }),
);
...
export const financialMetrics = pgTable(
  "financial_metrics",
  {
    ...
    burnRate: decimal("burn_rate", { precision: 12, scale: 2 })
      .notNull()
      .default("0"),
    cashInflow: decimal("cash_inflow", { precision: 12, scale: 2 })
      .notNull()
      .default("0"),
    cashOutflow: decimal("cash_outflow", { precision: 12, scale: 2 })
      .notNull()
      .default("0"),
    createdAt: timestamp("created_at").notNull().defaultNow(),
  },
...
export const projectFinancials = pgTable(
  ...
  (table) => ({
    projectIdIdx: index("project_financials_project_id_idx").on(
      table.projectId,
    ),
  }),
);
...
export const twoFactorStatusRelations = relations(
  twoFactorStatus,
  ({ one }) => ({
